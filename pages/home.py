...
Check out the [GitHub repo](https://github.com/PierreMarieCurie/ASCII-Art-Generator) and join the fun!
""")
...
""")
st.image("illustration/classic.jpg", caption="Example of Classic Mode")
...
""")
st.image("illustration/portrait.jpg", caption="Example of Portrait Mode")
...
""")
st.image("illustration/multiportrait.jpg", caption="Example of Multi-Portrait Mode")
